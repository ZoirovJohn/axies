          ...
          <div className="row">
            <div className="col-md-12">
              <div className="heading-live-auctions mg-bt-22">
                <h2 className="tf-title pb-17">{t("CreateSellNFTHome-1")}</h2>
              </div>
            </div>
            <div className="col-md-12">
              <div className="sc-box-icon-inner style2">
                <div className="sc-box-icon">
                  ...
                  <h3 className="heading">
                    <Link href="/connect-wallet">{t("CreateSellNFTHome-2")}</Link>
                  </h3>
                  <p className="content">
                    {t("CreateSellNFTHome-3")}
                  </p>
                </div>
                <div className="sc-box-icon">
                  <div className="image">
                  ...
                  <h3 className="heading">
                    <Link href="/connect-wallet">{t("CreateSellNFTHome-4")}</Link>
                  </h3>
                  <p className="content">
                    {t("CreateSellNFTHome-5")}
                  </p>
                </div>
                <div className="sc-box-icon">
                  <div className="image">
                  ...
                  <h3 className="heading">
                    <Link href="/connect-wallet">{t("CreateSellNFTHome-6")}</Link>
                  </h3>
                  <p className="content">
                    {t("CreateSellNFTHome-7")}
                  </p>
                </div>
                <div className="sc-box-icon">
                  <div className="image">
                  ...
                  <h3 className="heading">
                    <Link href="/connect-wallet">{t("CreateSellNFTHome-8")}</Link>
                  </h3>
                  <p className="content">
                    {t("CreateSellNFTHome-9")}
                  </p>
                </div>
              </div>
            </div>
