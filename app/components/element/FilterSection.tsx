                  ...
                  >
                    <div
                      className={`sort-filter ${
                        item.id === getCategorySelect ? "active" : ""
                      }`}
                    >
                      <span>
                        <Image height={25} width={25} src={item.img} alt="" />{" "}
                        {item.title}
                      </span>
